...
export function generateProductsForSubcategory(
  ...
  for (let i = 0; i < count; i++) {
    ...
    products.push({
      ...
      image: `https://placehold.co/400x400/f97316/ffffff?text=${encodeURIComponent(subcategory)}+${variant}`,
      rating: randomRating(),
